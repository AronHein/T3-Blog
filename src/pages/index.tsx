                ...
                <div className="flex w-full items-center space-x-2">
                  ...
                  <div>
                    <p className="font-semibold">
                      Firstname Lastname &#x2022; 29 Jan. 2025
                    </p>
                ...
                <div className="grid w-full grid-cols-12 gap-4">
                  <div className="col-span-8 flex flex-col space-y-4">
                    ...
                    <p className="break-words text-sm text-gray-500">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Dolorum aut corrupti nemo modi a totam consequuntur ullam
                      provident delectus et consequatur magnam exercitationem
                      esse beatae numquam quaerat obcaecati, harum eum ipsa
                      asperiores. Beatae dolor quasi hic ab dolores omnis modi
                      odio exercitationem aliquam cumque id dolorem iste, ullam
                      molestiae voluptatum rem pariatur enim quisquam minima
                      repellat aperiam. Recusandae, esse error?
                    </p>
                  </div>
